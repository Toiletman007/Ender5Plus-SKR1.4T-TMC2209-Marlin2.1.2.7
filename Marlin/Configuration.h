...
#define CUSTOM_MACHINE_NAME "Creality Ender 5 Plus SKR1.4T"
 ...
 */
// Z was in fact 800 not 400 thats why i had such issues finding the flippin extrusion step per mm
...
//Commented for tuning the printer
...
#define Z_AFTER_PROBING           1 // (mm) Z position after probing is done

// DO NOT!! set below -2 the gantry will try to dig a hole in the bed!!!
...
//changed
#define DELAY_BEFORE_PROBING 150  // (ms) To prevent vibrations from triggering piezo sensors
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  //yes 690mm is what i measured on the actual machine it's right before the direct extruder so it can push the rest into it
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define G26_MESH_VALIDATION
    ...
    #define MESH_TEST_LAYER_HEIGHT   0.22  // (mm) Default layer height for G26.
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_INSET_LFRB { 50, 10, 50, 10 } // (mm) Left, Front, Right, Back insets
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_Y_POINT 300  // (mm) Y point for Z homing
#endif
